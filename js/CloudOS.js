; (function()
{
    ...
    // ------------------------------------------------------------------------
    // This seems specific to sending friend's notifications 
    // (that's what token is, see https://github.com/kynetx/CloudOS/blob/216996a29f34f046503b94ae6477e9cb75ccda4d/CloudAPI/a169x727.krl)
    // ------------------------------------------------------------------------
    CloudOS.sendNotificationOld = function(application, subject, body, priority, token, postFunction)
    {
        var eventAttributes = {
    ...
    CloudOS.sendNotification = function(application, subject, body, priority, postFunction)
    {
        var eventAttributes = {
            "application": application,
            "subject": subject,
        ...
        CloudOS.raiseEvent('notification', 'status', eventAttributes, {}, postFunction);
    };
